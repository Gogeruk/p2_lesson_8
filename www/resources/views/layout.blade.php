            ...
            <div class="form-group row m-2">
                <div class="m-3 text-center">
                    <div class="m-3 text-center border border-danger">
                        ...
                        <button onclick="location.href='/category'" type="submit" class="btn btn-danger" name="button">list-categories</button>
                        <button onclick="location.href='/tag'" type="submit" class="btn btn-danger" name="button">list-tags</button>
                    </div>
                </div>
            </div>
